define(function(require) {
	...
	var AddressSelect = Backbone.View.extend({
		initialize : function($province, $city, $country) {
			...
			this.view = new View(this.model, $province, $city, $country);
		},
		getProvince : function() {
			var name = this.model.get('currentProvince');

			return {
				id : this.view.getID('province', name),
				name : name
			}
		},
		getCity : function() {
			var name = this.model.get('currentCity');

			return {
				id : this.view.getID('city', name),
				name : name
			}
		},
		getCountry : function() {
			var name = this.model.get('currentCountry');

			return {
				id : this.view.getID('country', name),
				name : name
			}
		}
	});
